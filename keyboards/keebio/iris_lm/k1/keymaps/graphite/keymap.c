...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [Base] = LAYOUT(
        ...
        KC_NO,          LT(Sys,KC_B), KC_L, KC_D,  KC_W,    KC_Z,             KC_SCLN, KC_F,    KC_O,    KC_U,    KC_J,    KC_RSFT,
        KC_LGUI,        KC_N,    KC_R,    KC_T,    KC_S,    KC_G,              KC_Y,    KC_H,    KC_A,    KC_E,    KC_I,    MO(Num),
    ...
    [Num] = LAYOUT(
        KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,                    KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,
        _______, _______, KC_7,    KC_8,    KC_9,    _______,                  MM_STAR, KC_7,    KC_8,    KC_9,    KC_MINS, _______,
        _______, _______, KC_4,    KC_5,    KC_6,    _______,                  KC_EQL,  KC_4,    KC_5,    KC_6,    KC_PLUS, _______,
        KC_TAB,  KC_0,    KC_1,    KC_2,    KC_3,    _______, _______, _______,  MM_SLASH,KC_1,    KC_2,    MM_N3,   KC_0,    _______,
